              ...
              <>
                <View style={styles.Trademark}>
                  ...
                  <View style={styles.Imagecontainer}>
                    <Image
                      source={selectedImage ? { uri: selectedImage.uri } : require('../assets/addIcon.png')}
                  ...
                  <View style={styles.searchSection}>
                    <DropDown
                      ...
                      onChange={(option) => { setSelectedTech(option) }}
                      style={styles.input}
                      placeholder="Select Technology"
                      value={selectedTech.label}
                    />
                  </View>
                  ...
                  <View style={styles.searchSection}>
                    ...
                    <TouchableOpacity onPress={
                      () => {
                        ...
                        formData.append('IpFilterId', selectedTech.key);
...
PatentScreen.navigationOptions = navData => {
  return {
