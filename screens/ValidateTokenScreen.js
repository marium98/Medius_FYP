...
import { VALIDATE_RESET } from '../constants/actions';
                                            ...
                                            <>
                                                <View style={styles.SectionStyle}>
                                                    <Text style={styles.registerTextStyle}>
                                                        Please enter the validation token sent to your email
                                                    </Text>
                                                </View>
                                                <View style={styles.SectionStyle}>
                                                    <CodeField
                                                ...
                                                <TouchableOpacity
                                                    ...
                                                    activeOpacity={0.5}
                                                    onPress={() => dispatch(customisedAction(VALIDATE_RESET,{resetToken: value , navigation
                                                    }))}
                                                    >
                                                    <View>
